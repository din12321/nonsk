...
<html class="loading">
  ...
  <div class="content-body">
			...
			<div class="card">
				<div class="card-body text-center">
					...
					<textarea rows="1"class="form-control text-center" style="width: 30%; float: right margin-bottom: 5px;" id="cst" placeholder="ᴄᴜꜱᴛᴏᴍ ᴀᴍᴏᴜɴᴛ ᴏʀ ʟᴇᴀᴠᴇ ɪᴛ ʙʟᴀɴᴋ"></textarea></br>
						...
						<textarea rows="1"class="form-control text-center" style="width: 100%; float: right margin-bottom: 5px;" id="orderid" placeholder="Order ID"></textarea></br>
    ...
    <option </option>
        ...
        <option style="background:rgba(16, 15, 154, 0.281);color:rgb(25, 208, 1);color:white" value="gate/api1.php">api 1 nonsk</option>
